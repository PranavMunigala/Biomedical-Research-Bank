...
**Source:** Anthropic beta launch announcement (June 30, 2026); Novo Nordisk partnership announcement (September 16, 2026); Bristol Myers Squibb rollout announcement (May 2026)
...
Pharma partnerships built on Claude/Claude Science (adoption picking up through 2026):

- **Novo Nordisk** (announced September 16, 2026) — will initially test Anthropic's models and Claude Science on specific R&D workflows, chosen for where the two companies' combined strengths promise the most impact, plus a separate push to strengthen AI-driven software development company-wide. The arrangement includes data governance protocols and human oversight to keep AI use compliant. CEO Mike Doustdar: "AI can help us increase productivity in R&D and compress the path from research to marketed product." Dario Amodei: "AI's increasing capability brings with it the potential to compress a century's worth of biological and medical breakthroughs into a decade." Novo had already struck a separate AI deal with OpenAI earlier in 2026 and set up an AI innovation hub with AWS.
- **Bristol Myers Squibb** (announced May 2026) — a broader deployment than Novo's: rolling out Claude Enterprise to more than 30,000 employees across research, clinical trial documentation, manufacturing quality, and commercial operations. Follows a stated three-year internal AI investment.
...
Named enterprise/pharma users so far: Novo Nordisk, Allen Institute, with references to Evinova and AbbVie also using Claude for research/clinical development work. (Bristol Myers Squibb's much larger enterprise-wide rollout uses Claude Enterprise rather than Claude Science specifically.)

Anthropic is funding external adoption too: up to 50 Claude Science research projects with up to $30,000 in Claude credits each, projects running Sept 1–Dec 1, 2026.

The internal drug programs are pre-clinical and very early — no disclosed disease targets, funding levels, or timeline to human trials as of this writing.

## Personal Takeaways

Interesting as a case study in a foundation-model company vertically integrating into a specific industry — Anthropic is testing its own product by becoming a drug-discovery customer of itself.

The "neglected diseases" framing is a genuinely different strategic angle vs. profit-maximizing drug-discovery startups — worth watching whether it produces real preclinical candidates.

The Solomon critique remains the most important open question for the field: if clinical trials, not discovery, are the real bottleneck, AI-accelerated discovery could just mean more candidates entering the same slow, expensive, high-failure-rate pipeline.

Simple read on the Novo Nordisk news: this is a pilot, not a full rollout — Novo is testing Claude Science on a handful of hand-picked R&D problems first, with compliance guardrails built in, rather than betting the whole company on it (contrast with BMS's much bigger enterprise-wide bet). It's another data point that big pharma is hedging across several AI labs (Anthropic, OpenAI, AWS) rather than committing to one.

**Not independently verified:** exact list of the 60+ databases/toolkits and 40+ Python packages, full terms of the Coefficient Bio acquisition, and specific R&D workflows named in the Novo Nordisk pilot — this profile is based on announcement-level summaries, not primary technical documentation.
